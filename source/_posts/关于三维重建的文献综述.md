...
> 5. End-to-end Recovery of Human Shape and Pose
> 6. Multi-Garment Net: Learning to Dress 3D People from Images
> 7. pvnet 遮挡截断情况下可以做6DoF Pose Estimation
...
### 2019.11.1
解决在detectron2上生成densepose IUV图像的问题（用applynet dump）  
出tex2shape重建结果  
...
## conda env
  ...
  * tf2: python2 + tf1.14, hmr, tex2shape
  * tf: python3 + tf1.14
