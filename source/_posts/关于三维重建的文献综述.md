...
## Learning to Reconstruct People in Clothing from a Single RGB Camera(video2mesh延伸论文，同一实验室)
...
## Learning to Reconstruct People in Clothing from a Single RGB Camera（2019.4）
...
{% word 19.6.25_weekly_report.docx %}
