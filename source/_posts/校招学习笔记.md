...
[数据库索引](http://blog.codinglabs.org/articles/theory-of-mysql-index.html)：索引是对数据库表中一个或多个列（例如，employee   表的姓氏   (lname)   列）的值进行排序的结构  
...
腾讯魔方--游戏客户端--8.10已投8.23笔试8.24光子一面挂  
    ...
    --游戏引擎--9.2已投--9.6笔试
快手--游戏客户端--8.5已投--9.9一面
爱奇艺--游戏客户端--8.16已投8.22笔试
百度--c++--8.16已投
贝壳--ue4引擎开发--8.16已投要求dx11api--如视，新团队，第一年校招，有技术大佬，--9.11一面
网易互娱--游戏引擎游戏研发--8.17已投--9.5笔试--9.14一面
美团--测开--8.22笔试--8.31一面--美团优选移动端app测开--挂
小米--Unity--8.20已投--9.8笔试
